...
progressbar를 만드는데 jquery-ui에 ProgressBar를 이용해서 만든다.
id는 창마다 하나씩 만든다.
중복해서 만들수있으므로 uuid-progress  형식으로 id를 고정으로 가져간다.
*/
function ProgressMngr(uuid) {
    var tmp = `
    <div id="`+uuid+`-progress" title="Loading...">
        <img style="border: 0;" 
  ...
  `
    ...
    dialog.on( "dialogopen", function( event, ui ) {
        //console.log(ui);
        //오버레이 크기는 클래스로 지정되어있다. 이는 창마다 생성된다.
        //ui-widget-overlay ui-front
        //https://stackoverflow.com/questions/5965971/jquery-ui-dialog-ui-widget-overlay-height-problem
        //아래처럼 세팅할 수있는데
        //크기는 uuid로 가져온 값으로해야겠지.
        //var a = $("#9912d6c4-4b3f-476f-ba96-3a6e3cdbc417")
        //a.offset().top  ==>71
        //a.offset().left  ==>1
        //a.width() ==>924
        //a.height  =>573
        ...
        $("#" + uuid+"-progress").siblings(".ui-dialog-titlebar").find(".ui-dialog-titlebar-close").hide();
    } );
