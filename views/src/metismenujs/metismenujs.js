    ...
    ***************************************************************************** */
    ...
    var MetisMenu = /** @class */ (function () {
        ...
        MetisMenu.prototype.show = function (ul) {
            ...
            */
            if (this.isTransitioning && this.config.expand == false) {
                return;
            }

            if (ul.classList.contains(ClassName.COLLAPSING) && this.config.expand == false) {
                return;
            }
            ...
            if (this.config.toggle && eleParentSiblins.length > 0) {
                for (var _i = 0, eleParentSiblins_1 = eleParentSiblins; _i < eleParentSiblins_1.length; _i++) {
                    ...
                    if (sibUl !== null) {
                        /*이게 show가 될때 나머지것들을 숨기는 그런것 */
                        if (this.config.expand == false) {  /*if문 내가 넣은거 */
                            this.hide(sibUl);
                        }
